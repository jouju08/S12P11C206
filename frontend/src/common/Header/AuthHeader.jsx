  ...
  return (
    <header className="bg-main-background">
      <div className="w-[1024px] h-[100px] relative m-auto">
        ...
        />
        <div className="left-[488px] top-[35px] absolute service-bold3 text-first cursor-pointer hover:text-main-choose">
          <Link to="/tale/lobby">동화만들기</Link>
        </div>
        <div className="left-[638px] top-[35px] absolute service-bold3 text-first cursor-pointer hover:text-main-choose">
