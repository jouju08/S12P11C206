...
export default function NavMenu({ location, children }) {
  ...
  return (
    <Link className="w-[137px] h-[200px] py-[21px] bg-main-btn rounded-tr-[30px] rounded-bl-[30px] border border-gray-200 flex-col justify-center items-center inline-flex overflow-hidden">
