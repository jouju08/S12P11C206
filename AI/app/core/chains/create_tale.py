...
제목: 잭과 콩나무   
필수문장:   
['잭은 하늘까지 닿은 거대한 콩나무를 타고 올라갔습니다.', '그는 구름 위에 숨겨진 거인의 성을 발견했습니다.', '용기를 내어, 아침 노래를 부르는 황금 하프를 훔쳤습니다.','거인이 쫓아오는 동안, 콩나무가 흔들리기 시작했습니다.'] 
도입: 
...
제목: 성냥팔이 소녀 
필수문장: 
['성냥팔이 소녀는 편지지를 피워 따뜻함을 느꼈습니다.', '성냥팔이 소녀는 물방울을 보며 행복한 꿈을 꾸었습니다.', '성냥팔이 소녀는 감자을 향해 손을 뻗었습니다.', '사람들은 성냥팔이 소녀의 토끼를 발견하지 못했습니다.']
도입: 
...
제목: 아기돼지 삼형제 
필수문장: 
['첫번째 아기돼지는 구름으로 만든 집을 지었습니다.', '두번째 아기돼지는 깃털으로 만든 집을 지었습니다.', '세번째 아기돼지는 초콜릿으로 만든 집을 지었습니다.', '늑대는 아기돼지의 집을 망치로 무너뜨렸습니다.'] 
도입: 
