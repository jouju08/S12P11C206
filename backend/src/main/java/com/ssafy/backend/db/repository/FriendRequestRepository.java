...
public interface FriendRequestRepository extends JpaRepository<FriendRequest, Long> {
    ...
    @Query("SELECT fr FROM FriendRequest fr WHERE fr.proposerId= :senderId AND fr.recipientId = :receiverId")
    ...
    Optional<FriendRequest> findByReceiverMemberId(@Param("receiverMemberId") Long receiverMemberId);
